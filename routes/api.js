...
loghandler = {
    error: {
        status: false,
        code: 503,
        message: 'Masih Dalam Tahap Pengembangan',
        maintanied_by: `${creator}`
    },
    apikey: {
    	status: false,
    	code: 403,
    	message: 'Apikey Salah hubungi saya di whatsapp untuk mendapatkan apikey anda',
    	maintanied_by: `${creator}`
    },
    noturl: {
    	status: false,
    	code: 403,
    	message: 'Silahkan masukkan parameter url',
    	maintanied_by: `${creator}`,
    }
}
